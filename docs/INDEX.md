...
| 5 | `docs/TRACEABILITY_TEMPLATE.md` | DV-1103 requirement traceability and documentation truth-audit template |
...
| Release acceptance | RELEASE, RELEASE_ACCEPTANCE, TRACEABILITY_TEMPLATE, PRODUCT_SPEC, TESTING, UI_UX_SPEC, ADR-008, ADR-010 |
