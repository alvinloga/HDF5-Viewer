...
| `gui/` | shell, tabs, trees, views | legacy main window, sidebar package, secondary Search/Plugins panel, and old activity-rail chrome modules removed in DV-1008; remaining GUI groups are removed only after target shell/view parity checks |
