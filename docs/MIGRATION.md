...
| `plugins/` | legacy plugin base/API; built-in analyses/plots coupled to current app | legacy built-ins removed in DV-1008 after Plugin API v1 parity coverage; remove remaining base/API separately |
