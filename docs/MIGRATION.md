...
| `gui/` | shell, tabs, trees, views | removed in DV-1008 after target shell, theme, view, command, state, navigation, accessibility, and document/editing parity coverage |
