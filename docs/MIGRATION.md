...
| `core/` | HDF5-centric loading/models/cache/event bus/slicer | cache, event-bus, and string-slicer modules removed in DV-1008; remaining behavior replaced through DataSource/domain contracts one group at a time |
