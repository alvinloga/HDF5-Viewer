...
| `gui/` | shell, tabs, trees, views | legacy main window, sidebar package, and secondary Search/Plugins panel removed in DV-1008; remaining GUI groups are removed only after target shell/view parity checks |
