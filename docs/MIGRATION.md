...
| `gui/` | shell, tabs, trees, views | legacy main window, sidebar package, secondary Search/Plugins panel, old activity-rail chrome modules, and obsolete status/bottom/command chrome removed in DV-1008; remaining GUI groups are removed only after target shell/view parity checks |
